...
<title>UrStore | Electronics | Mobile-Acc</title>
</head>
<body>
	<?php
					...
					<div class="collapse navbar-collapse" id="collapsibleNavbar">
						...
						<ul class="nav navbar-nav">
							...
							echo "$count </span></a></li> ";
								...
								echo "<li class='nav-item'><a class='nav-link' href='#'><i class='fa fa-shopping-cart'></i> Cart <span class='badge badge-warning'></span></a></li> 
...
$servername="localhost";
					...
					// Check connection
							...
							$product_query="SELECT * FROM products WHERE sub_cat_id='3' ORDER BY RAND() LIMIT 0,28";
